...
public class SearchBar extends LinearLayout {
    ...
    private void init() {
        ...
        View view=inflate(getContext(), R.layout.notes_search, this);
        layout= view.findViewById(R.id.recommend_search_layout);
        ...
        etSearch = findViewById(R.id.drawer_search);
     ...
     * 取消键点击事件处理
     **/
    private final OnClickListener cancelClickListener = v -> {
        if (state == STATE_EDIT) {
            state = STATE_VIEW;
            changeState();
        }
     ...
     * EditText Touch事件处理
     **/
    private final OnTouchListener editTextOnTouchListener = new OnTouchListener() {
        @Override
