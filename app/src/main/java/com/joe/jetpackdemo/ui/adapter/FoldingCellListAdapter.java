...
import com.joe.jetpackdemo.binding.ShoeBindingAdapterKt;
...
public class FoldingCellListAdapter extends ArrayAdapter<Course> {
    ...
    public FoldingCellListAdapter(Context context, List<Course> objects) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        ShoeBindingAdapterKt.bindImageFromUrl(viewHolder.cellImg,item.getImgUrl());
